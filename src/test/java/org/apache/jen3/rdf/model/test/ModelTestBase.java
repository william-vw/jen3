...
public class ModelTestBase extends GraphTestBase
{
	...
	protected static String nice( final RDFObject n )
	{
	...
	public static RDFObject rdfNode( final Model m, final String s )
	{
		return m.asRDFObject(NodeCreateUtils.create(m, s));
	}

	public static <T extends RDFObject> T rdfNode( final Model m, final String s,
			final Class<T> c )
	{
	...
	public static Statement statement( final Model m, final String fact )
	{
		...
		final RDFObject obj = ModelTestBase.rdfNode(m, st.nextToken());
