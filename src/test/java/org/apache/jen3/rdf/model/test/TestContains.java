...
public class TestContains extends AbstractModelTestBase
{
			...
			final String resource )
	{
		...
		final RDFObject r = ModelHelper.rdfNode(m, resource);
	...
	public void testCWN( final boolean yes, final String facts,
			final Resource S, final Property P, final RDFObject O )
	{
	...
	public void testModelComContainsSPcallsContainsSPO()
	{
		...
		final Model m = new ModelCom(g) {
			@Override
			public boolean contains( final Resource s, final Resource p,
					final RDFObject o )
			{
				wasCalled[0] = true;
