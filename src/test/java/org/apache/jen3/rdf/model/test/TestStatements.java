...
public class TestStatements extends AbstractModelTestBase
{
	...
	public void testOtherStuff()
	{
		...
		final Resource O = A.createResource("jena:O");
		A.add(S, P, O);
		B.add(S, P, O);
	...
	public void testSet()
	{
		...
		final Property P = A.createProperty("jena:P");
		final RDFObject O = A.createResource("jena:O");
	...
	public void testStatementPrintsType()
	{
		...
		final RDFObject O = model.createTypedLiteral("42", fakeURI);
	...
	public void testStatmentMap1Selectors()
	{
		...
		Assert.assertEquals(ModelHelper.resource("pred"), stmt.getPredicateProperty()) ;
