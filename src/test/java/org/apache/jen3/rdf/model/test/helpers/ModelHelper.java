...
package org.apache.jen3.rdf.model.test.helpers;
...
import org.apache.jen3.rdf.model.test.AbstractModelTestBase;
...
public class ModelHelper extends GraphTestBase
{
	...
	public static Statement statement( Model m, String fact )
	{
		...
		RDFObject obj = rdfNode( m, st.nextToken() );
	...
	{ return m.asRDFObject( NodeCreateUtils.create( m, s ) ); }

	public static <T extends RDFObject> T rdfNode( Model m, String s, Class<T> c )
