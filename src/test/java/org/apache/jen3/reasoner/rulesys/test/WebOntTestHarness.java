...
import org.apache.jen3.reasoner.rulesys.FBRuleInfGraph;
...
//            System.out.println("Starting: " + test);
    ...
    public void comprehensionAxioms(Model premises, Model conclusions) {
        ...
        while (ri.hasNext()) {
            ...
            while (pi.hasNext()) {
                ...
                while (vi.hasNext()) {
                    ...
                    if ( ! rs.getPredicateProperty().equals(OWL.onProperty)) {
                        ...
                        Resource comp = premises.createResource()
                            ...
                            .addProperty(rs.getPredicateProperty(), rs.getObject());
        ...
        StmtIterator ii = conclusions.listStatements(null, OWL.intersectionOf, (Resource)null);
        ...
        StmtIterator io = conclusions.listStatements(null, OWL.oneOf, (Resource)null);
        while (io.hasNext()) {
