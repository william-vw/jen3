...
import org.apache.jen3.reasoner.ValidityReport.Report;
import org.apache.jen3.reasoner.rulesys.RDFSFBRuleReasonerFactory;
        ...
        public void runTest() throws IOException {
            ...
            if (config != null) {
                for (StmtIterator i = config.listProperties(); i.hasNext();) {
                    ...
                    configuration.addProperty(s.getPredicateProperty(), s.getObject());
                }
            }
