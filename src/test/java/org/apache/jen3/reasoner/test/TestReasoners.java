...
import org.apache.jen3.reasoner.transitiveReasoner.TransitiveReasonerFactory;
...
public class TestReasoners extends TestCase {
    ...
    public void doTestTransitiveReduction(Model model, Property dp) {
        ...
        for (ResIterator i = im.listSubjects(); i.hasNext();) {
            ...
            List<RDFObject> directLinks = new ArrayList<>();
            for (ResIterator j = im.listObjectsOfProperty(base, dp); j.hasNext(); ) {
    ...
    public void testModelFactoryRDFS() {
        ...
        StmtIterator i = result.listStatements( b, RDF.type, (Resource)null );
