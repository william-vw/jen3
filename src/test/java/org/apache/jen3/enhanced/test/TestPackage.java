...
import org.apache.jen3.enhanced.AlreadyLinkedViewException;
...
import org.apache.jen3.enhanced.GraphPersonality;
import org.apache.jen3.enhanced.Implementation;
import org.apache.jen3.enhanced.Personality;
import org.apache.jen3.enhanced.PersonalityConfigException;
import org.apache.jen3.enhanced.Polymorphic;
import org.apache.jen3.enhanced.UnsupportedPolymorphismException;
import org.apache.jen3.graph.Factory;
import org.apache.jen3.graph.Graph;
import org.apache.jen3.graph.Node;
import org.apache.jen3.graph.NodeFactory;
import org.apache.jen3.graph.NodeTypes;
import org.apache.jen3.graph.test.GraphTestBase;
...
public class TestPackage extends GraphTestBase  {
	...
	static final private  Personality<RDFObject> split = new Personality<>();
        
	static final private Personality<RDFObject> combo = new Personality<>();
    ...
    */
     ...
     */
    private static <X extends RDFObject> void miniAsSupports(String title, TestNode n, Class<X> intf, boolean rslt ) {
     ...
     */
    private static void basic(String title, Personality<RDFObject> p) {
    ...
    */
    ...
    private  void follow(String title, Personality<RDFObject> p) {
        Graph g = Factory.createGraphMem();
        TestModel model =  new TestModelImpl(g,p);
        // create some data
        graphAdd( g, "a b c;" );
    ...
    static class Example extends EnhNode implements RDFObject 
        {
        ...
        public NodeTypes getNodeType()
            { throw new JenaException( "getType() should not be called in the EnhGraph/Node tests" ); }
        ...
        @Override
        public Node visitWith( RDFVisitor rv )
            { return null; }
        }
    ...
    public void testSimple()
        {
        Graph g = Factory.createGraphMem();
        Personality<RDFObject> ours = BuiltinPersonalities.model.copy().add( Example.class, Example.factory );
    ...
    */
    public void testNullPointerTrap()
        {
        EnhGraph eg = new EnhGraph( Factory.createGraphMem(), new Personality<RDFObject>() ); 
