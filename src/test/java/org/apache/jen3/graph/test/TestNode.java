...
package org.apache.jen3.graph.test;
...
{    
    ...
    public void testVisitorPatternNode()
    {
        ...
        {
            @Override
            public Node visitAny( Node_ANY it, Object data ) { return it; }
            @Override
            public Node visitBlank( Node_Blank it, BlankNodeId id, Object data ) { return it; }
            @Override
            public Node visitLiteral( Node_Literal it, LiteralLabel lit, Object data ) { return it; }
            @Override
            public Node visitURI( Node_URI it, String uri, Object data ) { return it; }
            @Override
            public Node visitVariable( Node_Variable it, String name, Object data ) { return it; }
            @Override
            public Node visitRuleVariable(Node_RuleVariable it, Object data) { return it; }
            @Override
            public Node visitQuickVariable( Node_QuickVariable it, Object data ) { return it; }
			@Override
			public Node visitQuantifiedVariable(Node_QuantifiedVariable it, Object data) { return it; }
			@Override
			public Node visitQuantifier(Node_Quantifier it, Object data) { return it; }
			@Override
			public Node visitCollection(Node_Collection it, Object data) { return it; }
			@Override
			public Node visitCitedFormula(Node_CitedFormula it, Object data) { return it; }
        };
    ...
    {
        Node n = node( ns ); 
        assertEquals( n, n.visitWith( v, null ) ); 
    }

    private void visitExamples( NodeVisitor nv )
    {        
        node( "sortOfURI" ).visitWith( nv, null );        
        node( "?variableI" ).visitWith( nv, null );        
        node( "_anon" ).visitWith( nv, null );        
        node( "11" ).visitWith( nv, null );        
        node( "??" ).visitWith( nv, null );
    }
    ...
    public void testVisitorPatternCalled()
    {
        ...
        NodeVisitor checkCalled = new NodeVisitor() 
        {
            ...
            @Override
            public Node visitRuleVariable(Node_RuleVariable it, Object data) 
            { strings[0] += " ruleVariable"; return null; }
            @Override
            public Node visitQuickVariable( Node_QuickVariable it, Object data ) 
            { strings[0] += " quickVariable"; return null; }
			@Override
			public Node visitQuantifiedVariable(Node_QuantifiedVariable it, Object data) 
			{ strings[0] += " quantifiedVariable"; return null; }
			@Override
			public Node visitQuantifier(Node_Quantifier it, Object data) 
			{ strings[0] += " quantifier"; return null; }
			@Override
			public Node visitCollection(Node_Collection it, Object data) 
			{ strings[0] += " collection"; return null; }
			@Override
			public Node visitCitedFormula(Node_CitedFormula it, Object data) 
			{ strings[0] += " citedFormula"; return null; }
        };
    ...
    public void testNamespace()
    {
        ...
        {
            int split = TermUtil.splitNamespaceXML( uri );
