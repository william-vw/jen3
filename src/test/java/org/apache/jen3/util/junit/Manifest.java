...
package org.apache.jen3.util.junit;
...
import org.apache.jen3.vocabulary.TestManifestX;
...
public class Manifest
{
    ...
    public Manifest(String fn)
    {
        ...
        filename = org.apache.jen3.n3.io.N3IRIResolver.resolveGlobal(fn) ;
        log.debug("         = "+filename ) ;
    ...
    private void parseIncludes(Property property)
    {
        StmtIterator includeStmts = 
            manifest.listStatements(null, property, (Resource)null) ;
