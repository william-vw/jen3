...
package org.apache.jen3.rdfxml.xmlinput;
...
import org.apache.jen3.rdfxml.xmlinput.JenaReader;
import org.apache.jen3.rdfxml.xmlinput.ParseException;
import org.apache.jen3.reasoner.rulesys.RDFSRuleReasonerFactory;
import org.apache.jen3.reasoner.test.WGReasonerTester;
...
import org.apache.jen3.shared.wg.InputStreamFactoryTests;
import org.apache.jen3.vocabulary.OWLResults;
...
//                          wgDir);
                ...
                StmtIterator si =
                    m.listStatements( null, RDF.type, (Resource) null );
