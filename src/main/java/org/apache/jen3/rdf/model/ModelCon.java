...
/**
    ...
    @param n the graph.Node on which to base the Model.RDFObject
    @return a suitable RDFObject
*/
 ...
 */
    ...
    */
    public Statement createLiteralStatement( Resource s, Resource p, boolean o );
    
    /** 
        Answer a new Statement object (s, p, o') where o' is the typed literal
        corresponding to o using createTypedLiteral.
    */
    public Statement createLiteralStatement( Resource s, Resource p, float o );
    
    /** 
        Answer a new Statement object (s, p, o') where o' is the typed literal
        corresponding to o using createTypedLiteral.
    */
    public Statement createLiteralStatement( Resource s, Resource p, double o );
    
    /** 
        Answer a new Statement object (s, p, o') where o' is the typed literal
        corresponding to o using createTypedLiteral.
    */
    public Statement createLiteralStatement( Resource s, Resource p, long o );
    
    /** 
        Answer a new Statement object (s, p, o') where o' is the typed literal
        corresponding to o using createTypedLiteral.
    */
    public Statement createLiteralStatement( Resource s, Resource p, int o );
    
    /** 
        Answer a new Statement object (s, p, o') where o' is the typed literal
        corresponding to o using createTypedLiteral.
    */
    public Statement createLiteralStatement( Resource s, Resource p, char o );

    /** 
        Answer a new Statement object (s, p, o') where o' is the typed literal
        corresponding to o using createTypedLiteral.
    */
    public Statement createLiteralStatement( Resource s, Resource p, Object o );
     ...
     */
    public Statement createStatement(Resource s, Resource p, String o)  ;
     ...
     * @return the new statement
     */
    public Statement createStatement(Resource s, Resource p, String o, String l) ;
     ...
     * @return the new statement
     */
    public Statement createStatement(Resource s, Resource p, String o, String l, boolean wellFormed) ;
 ...
 */ 
    Model add(Resource s, Resource p, Resource o)     ;

    /** 
        Add the statement (s, p, createTypedLiteral( o )) to this model and
        answer this model.
    */ 
    Model addLiteral( Resource s, Resource p, boolean o );
    
    /**
        Add the statement (s, p, createTypedLiteral( o )) to this model and
        answer this model.
     */ 
    Model addLiteral( Resource s, Resource p, long o );
    
    /**
        Add the statement (s, p, createTypedLiteral( o )) to this model and
        answer this model.
     */     
    Model addLiteral( Resource s, Resource p, int o );
    
    /**
        Add the statement (s, p, createTypedLiteral( o )) to this model and
        answer this model.
    */ 
    Model addLiteral( Resource s, Resource p, char o ) ;
    
    /** 
        Add the statement (s, p, o') to the model, where o' is the typed
        literal corresponding to o. Answer this model.
    */ 
    Model addLiteral( Resource s, Resource p, float o );

    /** 
        Add the statement (s, p, o') to the model, where o' is the typed
        literal corresponding to o. Answer this model.
     */ 
    Model addLiteral( Resource s, Resource p, double o ) ;
     ...
     */ 
      @Deprecated Model addLiteral( Resource s, Resource p, Object o );
       ...
       * @param o the object of the statement to add
       */ 
        Model addLiteral( Resource s, Resource p, Literal o );
     ...
     * @param o the object of the statement to add
     */ 
    Model add(Resource s, Resource p, String o) ;
    ...
    */ 
    Model add(Resource s, Resource p, String lex, RDFDatatype datatype) ;
 ...
 */ 
    Model add(Resource s, Resource p, String o, boolean wellFormed);
 ...
 */ 
    Model add(Resource s, Resource p, String o, String l) ;
...
/**
    ...
    */
    Model remove( Resource s, Resource p, Resource o );
 ...
 */ 
    ...
    */ 
    StmtIterator listLiteralStatements( Resource subject, Resource predicate, boolean object );
    ...
    /** 
        ...
        corresponding to <code>object</code>.
    */ 
    StmtIterator listLiteralStatements( Resource subject, Resource predicate, char object );
    ...
    /** 
        ...
        corresponding to <code>object</code>.
    */ 
    StmtIterator listLiteralStatements(Resource subject, Resource predicate, long object );
    ...
    /** 
        ...
        corresponding to <code>object</code>.
    */ 
    StmtIterator listLiteralStatements(Resource subject, Resource predicate, int object );
    ...
    /** 
        ...
        corresponding to <code>object</code>.
    */ 
    StmtIterator listLiteralStatements( Resource subject, Resource predicate, float object );
    ...
    /** 
        ...
        corresponding to <code>object</code>.
    */ 
    StmtIterator listLiteralStatements(Resource subject, Resource predicate, double  object );
     ...
     */ 
    StmtIterator listStatements( Resource subject, Resource predicate, String  object );
 ...
 */ 
    ...
    /**
        ...
        corresponding to o.
    */
    ResIterator listResourcesWithProperty( Resource p, boolean o );
    ...
    /**
        ...
        corresponding to o.
    */
    ResIterator listResourcesWithProperty( Resource p, long o );
    ...
    /**
        ...
        corresponding to o.
    */
    ResIterator listResourcesWithProperty( Resource p, char o );
    ...
    /**
        ...
        corresponding to o.
    */
    ResIterator listResourcesWithProperty( Resource p, float o );
    ...
    /**
        ...
        corresponding to o.
    */
    ResIterator listResourcesWithProperty( Resource p, double o );
    ...
    /**
        ...
        corresponding to o.
    */
    ResIterator listResourcesWithProperty( Resource p, Object o );
     ...
     */ 
    ResIterator listSubjectsWithProperty( Resource p, String o );
     ...
     */ 
    ResIterator listSubjectsWithProperty( Resource p, String o, String l );
                                           
    /**
        Answer true iff this model contains the statement (s, p, o') where
        o' is the typed literal corresponding to the value o.
    */
    boolean containsLiteral( Resource s, Resource p, boolean o );

    /**
        Answer true iff this model contains the statement (s, p, o') where
        o' is the typed literal corresponding to the value o.
    */
    boolean containsLiteral( Resource s, Resource p, long o );

    /**
        Answer true iff this model contains the statement (s, p, o') where
        o' is the typed literal corresponding to the value o.
    */
    boolean containsLiteral( Resource s, Resource p, int o );

    /**
        Answer true iff this model contains the statement (s, p, o') where
        o' is the typed literal corresponding to the value o.
    */
    boolean containsLiteral( Resource s, Resource p, char o );

    /** 
        Answer true iff this model contains (s, p, o') where o' is the typed
        literal corresponding to o.
    */ 
    boolean containsLiteral( Resource s, Resource p, float o );

    /**
        Answer true iff this model contains the statement (s, p, o') where
        o' is the typed literal corresponding to the value o.
    */
    boolean containsLiteral( Resource s, Resource p, double o );

    /**
        Answer true iff this model contains the statement (s, p, o') where
        o' is the typed literal corresponding to the value o.
    */
    boolean containsLiteral( Resource s, Resource p, Object o );
 ...
 */ 
    boolean contains( Resource s, Resource p, String o );
 ...
 * @param l the language associated with the object
 */ 
    boolean contains( Resource s, Resource p, String o, String l );
}
