...
import org.apache.jen3.shared.BadBooleanException;
import org.apache.jen3.shared.BadCharLiteralException;
import org.apache.jen3.shared.PrefixMapping;

/** An implementation of Literal.
 */
public class LiteralImpl extends ResourceImpl implements Literal {
    ...
    */
    ...
    private boolean isPlainLiteral() {
        if ( JenaRuntime.isRDF11 )
            return TermUtil.isLangString(this) || TermUtil.isSimpleString(this) ;  
        else
