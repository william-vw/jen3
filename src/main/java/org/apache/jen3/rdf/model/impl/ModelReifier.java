...
import org.apache.jen3.shared.AlreadyReifiedException;
...
public class ModelReifier
    ...
    */ 
    public void noteIfReified( RDFObject s, RDFObject p, RDFObject o )
        {
    ...
    */
    private void noteIfReified( RDFObject n )
        {
