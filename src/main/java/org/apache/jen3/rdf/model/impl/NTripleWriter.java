...
public class NTripleWriter extends Object implements RDFWriter {
    ...
    public void write(Model model, Writer writer, String base)
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                pw.print(" ");
                writeResource(stmt.getPredicateProperty(), pw);
                pw.print(" ");
    ...
    public static void write(Model model, PrintWriter writer) {
        ...
        while (iter.hasNext()) {
            ...
            writer.print(" ");
            writeResource(stmt.getPredicateProperty(), writer);
            writer.print(" ");
    ...
    protected static void writeNode(RDFObject n, PrintWriter writer)
         {
