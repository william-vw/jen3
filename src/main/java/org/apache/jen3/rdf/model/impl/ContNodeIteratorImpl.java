 ...
 */
public class ContNodeIteratorImpl extends NiceIterator<RDFObject> implements NodeIterator
    {
    ...
    @Override public RDFObject next() throws NoSuchElementException 
        {
    ...
    @Override
    public RDFObject nextNode() throws NoSuchElementException 
        { return next(); }
