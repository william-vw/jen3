...
import org.apache.jen3.assembler.AssemblerHelp;
import org.apache.jen3.graph.Factory;
import org.apache.jen3.graph.Graph;
import org.apache.jen3.graph.compose.Union;
import org.apache.jen3.graph.impl.SimpleGraphMaker;
...
import org.apache.jen3.ontology.impl.OntModelImpl;
import org.apache.jen3.rdf.model.impl.InfModelImpl;
import org.apache.jen3.rdf.model.impl.ModelCom;
import org.apache.jen3.rdf.model.impl.ModelMakerImpl;
...
public class ModelFactory extends ModelFactoryBase
{
    ...
    */
    ...
    /**
     * Answer a new N3 model constructed according to the specification, which includes
     * a ModelMaker which will create the necessary base model.
    */
    public static N3Model createN3Model( N3ModelSpec spec )
        { return new N3ModelImpl( spec ); }
    
    public static N3Model createN3Model( N3ModelSpec spec, Graph g )
    { return new N3ModelImpl( spec, g ); }
