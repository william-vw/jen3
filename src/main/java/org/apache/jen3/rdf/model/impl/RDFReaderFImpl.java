...
import org.apache.jen3.shared.NoReaderForLangException;
...
public class RDFReaderFImpl extends Object implements RDFReaderF {
	...
	/**
	 * Rewire to use an external RDFReaderF (typically, RIOT). Set to null to use
	 * old jena-core setup.
	 * 
	 * @param other
	 */
	...
	private static void reset() {
		Class<? extends RDFReader> rdfxmlReader = org.apache.jen3.rdfxml.xmlinput.JenaReader.class;
		Class<? extends RDFReader> ntReader = org.apache.jen3.rdf.model.impl.NTripleReader.class;
		Class<? extends RDFReader> turtleReader = org.apache.jen3.n3.turtle.TurtleReader.class;
		Class<? extends RDFReader> n3Reader = org.apache.jen3.n3.N3Reader.class;
