...
import org.apache.jen3.enhanced.BuiltinPersonalities;
import org.apache.jen3.enhanced.EnhGraph;
import org.apache.jen3.enhanced.Personality;
import org.apache.jen3.graph.Graph;
import org.apache.jen3.graph.GraphListener;
import org.apache.jen3.graph.GraphUtil;
...
import org.apache.jen3.rdf.model.ModelChangedListener;
import org.apache.jen3.rdf.model.ModelFactory;
import org.apache.jen3.rdf.model.NsIterator;
...
import org.apache.jen3.rdf.model.RDFReaderF;
import org.apache.jen3.rdf.model.RDFWriter;
import org.apache.jen3.rdf.model.RDFWriterF;
...
import org.apache.jen3.rdf.model.Selector;
...
import org.apache.jen3.shared.InvalidPropertyURIException;
import org.apache.jen3.shared.JenaException;
import org.apache.jen3.shared.Lock;
import org.apache.jen3.shared.LockMRSW;
...
import org.apache.jen3.util.iterator.Map1Iterator;
...
public class ModelCom extends EnhGraph implements Model, PrefixMapping, Lock {
	...
	/*
	 * Internal. During intialization, all sorts of class loading orders can happen.
	 * Many places create Models, calling into a ModelCom constructor. so this helps
	 * the runtime ensure that ModelCom is initialized before a ModelCom is created.
	 */
	...
	public ModelCom() {
		this(null, BuiltinPersonalities.model);
	}
	...
	public ModelCom(Graph base, Personality<RDFObject> personality) {
		super(base, personality);
		// JENA-1249. Touching the prefix mappings can incur initialization costs.
		// Also, must protect against defaultPrefixMapping being null due to
	...
	@Override
	public Model addLiteral(Resource s, Resource p, boolean o) {
		return add(s, p, createTypedLiteral(o));
	}

	@Override
	public Model addLiteral(Resource s, Resource p, long o) {
		return add(s, p, createTypedLiteral(o));
	}

	@Override
	public Model addLiteral(Resource s, Resource p, int o) {
		return add(s, p, createTypedLiteral(o));
	}

	@Override
	public Model addLiteral(Resource s, Resource p, char o) {
		return add(s, p, createTypedLiteral(o));
	}

	@Override
	public Model addLiteral(Resource s, Resource p, float o) {
		return add(s, p, createTypedLiteral(o));
	}

	@Override
	public Model addLiteral(Resource s, Resource p, double o) {
		return add(s, p, createTypedLiteral(o));
	}

	@Override
	public Model add(Resource s, Resource p, String o) {
		return add(s, p, o, "", false);
	}

	@Override
	public Model add(Resource s, Resource p, String o, boolean wellFormed) {
		add(s, p, literal(o, "", wellFormed));
		return this;
	}

	public Model add(Resource s, Resource p, String o, String lang, boolean wellFormed) {
		add(s, p, literal(o, lang, wellFormed));
		return this;
	}

	@Override
	public Model add(Resource s, Resource p, String lex, RDFDatatype datatype) {
	...
	@Override
	public Model add(Resource s, Resource p, String o, String l) {
		return add(s, p, o, l, false);
	}

	@Override
	@Deprecated
	public Model addLiteral(Resource s, Resource p, Object o) {
		return add(s, p, asObject(o));
	}

	@Override
	public Model addLiteral(Resource s, Resource p, Literal o) {
		return add(s, p, o);
	}

	private Resource asObject(Object o) {
		return o instanceof Resource ? (Resource) o : createTypedLiteral(o);
	}
	...
	@Override
	public boolean containsLiteral(Resource s, Resource p, boolean o) {
		return contains(s, p, createTypedLiteral(o));
	}

	@Override
	public boolean containsLiteral(Resource s, Resource p, long o) {
		return contains(s, p, createTypedLiteral(o));
	}

	@Override
	public boolean containsLiteral(Resource s, Resource p, int o) {
		return contains(s, p, createTypedLiteral(o));
	}

	@Override
	public boolean containsLiteral(Resource s, Resource p, char o) {
		return contains(s, p, createTypedLiteral(o));
	}

	@Override
	public boolean containsLiteral(Resource s, Resource p, float o) {
		return contains(s, p, createTypedLiteral(o));
	}

	@Override
	public boolean containsLiteral(Resource s, Resource p, double o) {
		return contains(s, p, createTypedLiteral(o));
	}

	@Override
	public boolean contains(Resource s, Resource p, String o) {
		return contains(s, p, o, "");
	}

	@Override
	public boolean contains(Resource s, Resource p, String o, String l) {
		return contains(s, p, literal(o, l, false));
	}

	@Override
	public boolean containsLiteral(Resource s, Resource p, Object o) {
	...
	protected StmtIterator listStatements(Resource S, Resource P, Node O) {
		return IteratorFactory.asStmtIterator(graph.find(asNode(S), asNode(P), O), this);
	}

	@Override
	public StmtIterator listStatements(Resource S, Resource P, Resource O) {
		return listStatements(S, P, asNode(O));
	}

	@Override
	public StmtIterator listStatements(Resource S, Resource P, String O) {
		return O == null ? listStatements(S, P, Node.ANY) : listStatements(S, P, NodeFactory.createLiteral(O));
	}

	@Override
	public StmtIterator listStatements(Resource S, Resource P, String O, String L) {
		if (O != null) {
			...
			if (L != null)
				return listStatements(S, P, NodeFactory.createLiteral(O, L));
	...
	@Override
	public StmtIterator listLiteralStatements(Resource S, Resource P, boolean O) {
		return listStatements(S, P, createTypedLiteral(O));
	}

	@Override
	public StmtIterator listLiteralStatements(Resource S, Resource P, long O) {
		return listStatements(S, P, createTypedLiteral(O));
	}

	@Override
	public StmtIterator listLiteralStatements(Resource S, Resource P, int O) {
		return listStatements(S, P, createTypedLiteral(O));
	}

	@Override
	public StmtIterator listLiteralStatements(Resource S, Resource P, char O) {
		return listStatements(S, P, createTypedLiteral(O));
	}

	@Override
	public StmtIterator listLiteralStatements(Resource S, Resource P, float O) {
		return listStatements(S, P, createTypedLiteral(O));
	}

	@Override
	public StmtIterator listLiteralStatements(Resource S, Resource P, double O) {
		return listStatements(S, P, createTypedLiteral(O));
	}
	...
	@Override
	public ResIterator listResourcesWithProperty(Resource p, boolean o) {
		return listResourcesWithProperty(p, createTypedLiteral(o));
	}

	@Override
	public ResIterator listResourcesWithProperty(Resource p, char o) {
		return listResourcesWithProperty(p, createTypedLiteral(o));
	}

	@Override
	public ResIterator listResourcesWithProperty(Resource p, long o) {
		return listResourcesWithProperty(p, createTypedLiteral(o));
	}

	@Override
	public ResIterator listResourcesWithProperty(Resource p, float o) {
		return listResourcesWithProperty(p, createTypedLiteral(o));
	}

	@Override
	public ResIterator listResourcesWithProperty(Resource p, double o) {
		return listResourcesWithProperty(p, createTypedLiteral(o));
	}

	@Override
	public ResIterator listResourcesWithProperty(Resource p, Object o) {
		return listResourcesWithProperty(p, createTypedLiteral(o));
	}

	@Override
	public ResIterator listSubjectsWithProperty(Resource p, RDFObject o) {
		return listResourcesWithProperty(p, o);
	}

	@Override
	public ResIterator listSubjectsWithProperty(Resource p, String o) {
		return listSubjectsWithProperty(p, o, "");
	}

	@Override
	public ResIterator listSubjectsWithProperty(Resource p, String o, String l) {
	 ...
	 * 
	 * @param lex     the lexical form of the literal
	 * @param typeURI the uri of the type of the literal, null for old style "plain"
	 *                literals
	 * @throws DatatypeFormatException if lex is not a legal form of dtype
	 */
	@Override
	...
	public Literal createTypedLiteral(Object value) {
		// Catch special case of a Calendar which we want to act as if it were an
		// XSDDateTime
	...
	@Override
	public Statement createLiteralStatement(Resource r, Resource p, boolean o) {
		return createStatement(r, p, createTypedLiteral(o));
	}

	@Override
	public Statement createLiteralStatement(Resource r, Resource p, long o) {
		return createStatement(r, p, createTypedLiteral(o));
	}

	@Override
	public Statement createLiteralStatement(Resource r, Resource p, int o) {
		return createStatement(r, p, createTypedLiteral(o));
	}

	@Override
	public Statement createLiteralStatement(Resource r, Resource p, char o) {
		return createStatement(r, p, createTypedLiteral(o));
	}

	@Override
	public Statement createLiteralStatement(Resource r, Resource p, float o) {
		return createStatement(r, p, createTypedLiteral(o));
	}

	@Override
	public Statement createLiteralStatement(Resource r, Resource p, double o) {
		return createStatement(r, p, createTypedLiteral(o));
	}

	@Override
	public Statement createStatement(Resource r, Resource p, String o) {
		return createStatement(r, p, createLiteral(o));
	}

	@Override
	public Statement createLiteralStatement(Resource r, Resource p, Object o) {
		return createStatement(r, p, asObject(o));
	}

	@Override
	public Statement createStatement(Resource r, Resource p, String o, boolean wellFormed) {
		return createStatement(r, p, o, "", wellFormed);
	}

	@Override
	public Statement createStatement(Resource r, Resource p, String o, String l) {
		return createStatement(r, p, o, l, false);
	}

	@Override
	public Statement createStatement(Resource r, Resource p, String o, String l, boolean wellFormed) {
		return createStatement(r, p, literal(o, l, wellFormed));
	}

	@Override
	public Statement createStatement(Triple t) {		
		return createStatement(asResource(t.getSubject()), asResource(t.getPredicate()), asResource(t.getObject()));
	}
	...
	/**
	 * Answer a (the) new empty list Until this is made the object or subject in the
	 * model, it will not appear in a written form.
	 * 
	...
	@Override
	public RDFObject getRDFObject(Node n) {
		return asRDFObject(n);
	}
	...
	static protected Node makeURI(String uri) {
	...
	private void updateNamespace(Set<String> set, Iterator<Node> it) {
		while (it.hasNext()) {
			...
			if (node.isURI()) {
				...
				String ns = uri.substring(0, TermUtil.splitNamespaceXML(uri));
	...
	@Override
	public PrefixMapping setBase(String uri) {
		getPrefixMapping().setBase(uri);
		return this;
	}
	...
	public boolean hasBase() {
		return getPrefixMapping().hasBase();
	}
	...
	/**
	 * Add all the statements to the model by converting them to an array of
	 * corresponding triples and removing those from the underlying graph.
	 */
	@Override
	...
	@Override
	public boolean containsResource(RDFObject r) {
		return GraphUtil.containsNode(graph, r.asNode());
	}

	@Override
	public boolean contains(Resource s, Resource p) {
		return contains(s, p, (RDFObject) null);
	}

	@Override
	public boolean contains(Resource s, Resource p, RDFObject o) {
		return graph.contains(asNode(s), asNode(p), asNode(o));
	}

	@Override
	public Statement getRequiredProperty(Resource s, Resource p) {
		Statement st = getProperty(s, p);
		if (st == null)
			throw new NotFoundException(p.toString());
		return st;
	}

	@Override
	public Statement getRequiredProperty(Resource s, Resource p, String lang) {
	...
	@Override
	public Statement getProperty(Resource s, Resource p) {
		StmtIterator iter = listStatements(s, p, (Resource) null);
		try {
	...
	@Override
	public Statement getProperty(Resource s, Resource p, String lang) {
	...
	public static Node asNode(RDFObject x) {
		return x == null ? Node.ANY : x.asNode();
	}

	private ResIterator listObjectsFor(Resource s, Resource p) {
		ClosableIterator<Node> xit = GraphUtil.listObjects(graph, asNode(s), asNode(p));
		return IteratorFactory.asResIterator(xit, this);
	}

	private ResIterator listSubjectsFor(Resource p, Resource o) {
	...
	@Override
	public ResIterator listResourcesWithProperty(Resource p) {
		return listSubjectsFor(p, null);
	}

	@Override
	public ResIterator listSubjectsWithProperty(Resource p) {
		return listResourcesWithProperty(p);
	}

	@Override
	public ResIterator listResourcesWithProperty(Resource p, Resource o) {
		return listSubjectsFor(p, o);
	}

	@Override
	public ResIterator listObjects() {
		return listObjectsFor(null, null);
	}

	@Override
	public ResIterator listObjectsOfProperty(Resource p) {
		return listObjectsFor(null, p);
	}

	@Override
	public ResIterator listObjectsOfProperty(Resource s, Resource p) {
	 ...
	 */
	@Override
	public Statement createStatement(Resource r, Resource p, RDFObject o) {
	...
	public StmtIterator listBySubject(Container cont) {
		return listStatements(cont, null, (Resource) null);
	}
	 ...
	 * 
	 * @see org.apache.jen3.rdf.model.Model#intersection(org.apache.jen3.rdf.model.Model)
	 */
	@Override
	 ...
	 * to check for membership. [So the first one should be "small" and the second
	 * one "membership cheap".]
	 */
