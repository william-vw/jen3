    ...
    implements RDFList
{
    ...
    public int size() {
        ...
        for (Iterator<Resource> i = iterator(); i.hasNext(); i.next()) {
            size++;
        } 
        return size;
    }
     ...
     */
    @Override
    public Resource setHead( Resource value ) {
        if (s_checkValid) {
            checkValid();
        }
     ...
     */
    @Override
    public RDFList cons( Resource value ) {
        if (s_checkValid) {
            checkValid();
        }
     ...
     */
    @Override
    public RDFList with( Resource value ) {
        if (s_checkValid) {
            checkValid();
        }
     ...
     */
    @Override
    public Resource replace( int i, Resource value ) {
        if (s_checkValid) {
            checkValid();
        }
     ...
     */
    @Override
    public int indexOf( Resource value, int start ) {
        if (s_checkValid) {
            checkValid();
        }
     ...
     * </p>
     * 
     * @param nodes An iterator whose range is Resource
     ...
     */
    @Override
    public RDFList append( Iterator<? extends Resource> nodes ) {
     ...
     */
    @Override
    public void concatenate( Iterator<? extends Resource> nodes ) {
    ...
    public void apply( ApplyFn fn ) {
        ...
        for (Iterator<Resource> i = iterator();  i.hasNext(); ) {
            fn.apply( i.next() );
        }
    }
     ...
     */
    @Override
    public <T> ExtendedIterator<T> mapWith( Function<Resource, T> fn ) {
     ...
     */
    @Override
    public RDFList remove( Resource val ) {
        if (s_checkValid) {
            checkValid();
        }
     ...
     */
    @Override
    public ExtendedIterator<Resource> iterator() {
    ...
    /**
     * <p>
     * Answer the contents of this RDF list as a Java list of Resource values.
     * </p>
     * 
     * @return The contents of this list as a Java List.
     */
    @Override
    public List<Resource> asJavaList() {
    ...
    public boolean sameListAs( RDFList list ) {
        ...
        while (!(r0.equals( nil ) || r1.equals( nil ))) {
            Resource n0 = r0.getRequiredProperty( head ).getObject();
            Resource n1 = r1.getRequiredProperty( head ).getObject();
     ...
     */
    public Resource newListCell( Resource value, Resource tail ) {
    ...
    private void checkValidProperty( Property p, Resource expected ) {
        int count = 0;
     ...
     * </p>
     * 
     * @param i An iterator of Resources
     * @return A list formed from all of the nodes of i, in sequence
     */
    protected RDFList copy( Iterator<? extends Resource> i ) {
        Resource list = null;
        Resource start = null;
     ...
     * </p>
     */
    protected class RDFListIterator extends NiceIterator<Resource>
    {
        // Instance variables
