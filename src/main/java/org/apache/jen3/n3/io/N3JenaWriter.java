...
public class N3JenaWriter implements RDFWriter
{
    ...
    /**
     * Name of the N3 full writer, supporting all N3 constructs.
     * 
     */
    static public final String n3WriterFullPrinter = "N3-FULL" ;
    ...
    N3JenaWriterCommon chooseWriter()
    {
        ...
        if ( writerName.equalsIgnoreCase(n3WriterFullPrinter) )
        	return new N3JenaWriterFull();
    ...
    */
    ...
    /**
     * @see org.apache.jen3.rdf.model.RDFWriter#setErrorHandler(org.apache.jen3.rdf.model.RDFErrorHandler)
     */
    @Override
