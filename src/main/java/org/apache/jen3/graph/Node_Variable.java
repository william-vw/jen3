...
public class Node_Variable extends Node_Fluid
    ...
    */
	...
	public Node_Named asNeedle() 
		{ return new Node_Named(getName()); }
    
    @Override
    public Node visitWith( NodeVisitor v, Object data )
        { return v.visitVariable( this, getName(), data ); }
    ...
    protected boolean equalsNamed(Object other)
	    {
    	return (other instanceof Node_Named && label.equals( ((Node_Named) other).getLabel() ));
	    }
