...
import org.apache.jen3.assembler.assemblers.AssemblerGroup.Frame;
    ...
    */
    ...
    private static String getIncomingProperty( Resource r )
        ...
        while (it.hasNext())
            ...
            incomings += prefix + nice( s.getPredicateProperty() ) + " of " + nice( s.getSubject() );
            prefix = ", ";
            }
        return incomings.equals( "" ) ? "" : " [" + incomings + "]";
        }

    protected static String nice( RDFObject r )
