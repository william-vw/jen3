    ...
    implements OntClass
{
    ...
    public ExtendedIterator<OntProperty> listDeclaredProperties( boolean direct ) {
        ...
        Set<RDFObject> candSet = new HashSet<>();
        ...
        List<RDFObject> cands = new ArrayList<>();
    ...
    protected boolean testDomain( Property p, boolean direct ) {
        ...
        for (StmtIterator i = getModel().listStatements( p, getProfile().DOMAIN(), (Resource) null ); i.hasNext();  ) {
