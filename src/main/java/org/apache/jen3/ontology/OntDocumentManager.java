...
import org.apache.jen3.vocabulary.OntDocManagerVocab;
 ...
 * resolving URI's and caching models to {@link org.apache.jen3.util.FileManager FileManager}.
...
public class OntDocumentManager
{
        ...
        while (!unloadQueue.isEmpty()) {
            ...
            if (model.hasLoadedImport( importURI )) {
                ...
                if (importModel != null) {
                    ...
                    for (StmtIterator i = importModel.listStatements( null, model.getProfile().IMPORTS(), (Resource) null ); i.hasNext(); ) {
                    ...
                    for (StmtIterator i = model.listStatements( null, model.getProfile().IMPORTS(), (Resource) null ); i.hasNext(); ) {
    ...
    protected void queueImports( Model model, List<String> readQueue, Profile profile ) {
        if (model instanceof OntModel) {
            ...
            StmtIterator i = model.listStatements( null, profile.IMPORTS(), (Resource) null );
    ...
    protected void processMetadata( Model metadata ) {
        ...
        for (ResIterator i = metadata.listResourcesWithProperty( RDF.type, DOC_MGR_POLICY ); i.hasNext(); ) {
            ...
            for (StmtIterator j = policy.listProperties();  j.hasNext(); ) {
                ...
                Property pred = s.getPredicateProperty();
