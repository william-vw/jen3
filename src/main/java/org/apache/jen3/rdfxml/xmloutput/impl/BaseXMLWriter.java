...
import org.apache.jen3.rdf.model.impl.RDFDefaultErrorHandler;
import org.apache.jen3.rdf.model.impl.ResourceImpl;
import org.apache.jen3.rdf.model.impl.TermUtil;
import org.apache.jen3.rdfxml.xmloutput.RDFXMLWriterI;
import org.apache.jen3.shared.*;
import org.apache.jen3.util.CharEncoding;
  ...
  public static SimpleLogger setLogger(SimpleLogger lg) {
    ...
    */
	...
	String splitTag(String uriref, int type) {
		int split = TermUtil.splitNamespaceXML( uriref );
...
//		}
    ...
    protected String substitutedAttribute( String s ) 
        {
        String substituted = TermUtil.substituteStandardEntities( s );
        if (!showDoctypeDeclaration.booleanValue()) 
            return attributeQuoted( substituted );
        else
            {
            int split = TermUtil.splitNamespaceXML( substituted );
    ...
    private void generateDoctypeDeclaration( Model model, PrintWriter pw )
        ...
        pw.print( "<!DOCTYPE " + rdfRDF +" [" );
            for ( String prefix : prefixes.keySet() )
            {
                ...
                pw.print(
                    newline + "  <!ENTITY " + strForPrefix( prefix ) + " '" + TermUtil.substituteEntitiesInEntityValue(
                        prefixes.get( prefix ) ) + "'>" );
            }
        pw.print( "]>" + newline );
        }
    ...
    /**
        ...
        Object representation of the original value.
     	...
     	@see org.apache.jen3.rdf.model.RDFWriter#setProperty(java.lang.String, java.lang.Object)
     */
	@Override
