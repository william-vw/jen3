...
import org.apache.jen3.vocabulary.RDFSyntax;
...
public class Basic extends BaseXMLWriter 
	...
	protected void writeRDFStatements
	    ...
	    {
		StmtIterator sIter = model.listStatements( subject, null, (Resource) null );
	...
	protected void writePredicate(Statement stmt, final PrintWriter writer)
		 {
		final Property predicate = stmt.getPredicateProperty();
		final RDFObject object = stmt.getObject();
	...
	protected void writeLiteral( Literal l, PrintWriter writer ) {
		...
		// Content.
		writer.print(">");
		writer.print( TermUtil.substituteEntitiesInElementContent( form ) );
	}
