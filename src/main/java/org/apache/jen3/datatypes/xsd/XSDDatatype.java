...
package org.apache.jen3.datatypes.xsd;
...
import org.apache.jen3.datatypes.xsd.impl.XSDBaseNumericType;
import org.apache.jen3.datatypes.xsd.impl.XSDBaseStringType;
import org.apache.jen3.datatypes.xsd.impl.XSDByteType;
import org.apache.jen3.datatypes.xsd.impl.XSDDateTimeStampType;
import org.apache.jen3.datatypes.xsd.impl.XSDDateTimeType;
import org.apache.jen3.datatypes.xsd.impl.XSDDateType;
import org.apache.jen3.datatypes.xsd.impl.XSDDayTimeDurationType;
import org.apache.jen3.datatypes.xsd.impl.XSDDayType;
import org.apache.jen3.datatypes.xsd.impl.XSDDouble;
import org.apache.jen3.datatypes.xsd.impl.XSDDurationType;
import org.apache.jen3.datatypes.xsd.impl.XSDFloat;
import org.apache.jen3.datatypes.xsd.impl.XSDMonthDayType;
import org.apache.jen3.datatypes.xsd.impl.XSDMonthType;
import org.apache.jen3.datatypes.xsd.impl.XSDPlainType;
import org.apache.jen3.datatypes.xsd.impl.XSDTimeType;
import org.apache.jen3.datatypes.xsd.impl.XSDYearMonthDurationType;
import org.apache.jen3.datatypes.xsd.impl.XSDYearMonthType;
import org.apache.jen3.datatypes.xsd.impl.XSDYearType;
import org.apache.jen3.ext.xerces.impl.dv.InvalidDatatypeValueException;
import org.apache.jen3.ext.xerces.impl.dv.SchemaDVFactory;
import org.apache.jen3.ext.xerces.impl.dv.ValidatedInfo;
import org.apache.jen3.ext.xerces.impl.dv.ValidationContext;
import org.apache.jen3.ext.xerces.impl.dv.XSSimpleType;
import org.apache.jen3.ext.xerces.impl.dv.util.Base64;
import org.apache.jen3.ext.xerces.impl.dv.util.HexBin;
import org.apache.jen3.ext.xerces.impl.dv.xs.DecimalDV;
import org.apache.jen3.ext.xerces.impl.dv.xs.XSSimpleTypeDecl;
import org.apache.jen3.ext.xerces.impl.validation.ValidationState;
import org.apache.jen3.ext.xerces.util.SymbolHash;
import org.apache.jen3.ext.xerces.xs.XSConstants;
import org.apache.jen3.ext.xerces.xs.XSTypeDefinition;
...
public class XSDDatatype extends BaseDatatype {
	...
	private static Map<Class<?>, XSDDatatype> clsToXsd = new HashMap<>();
...
// Methods
	 ...
	 * Constructor.
	 * 
	 * @param typeName the name of the XSD type to be instantiated, this is used to
	 *                 lookup a type definition from the Xerces schema factory.
	 */
	 ...
	 * @param typeName  the name of the XSD type to be instantiated, this is used to
	 *                  lookup a type definition from the Xerces schema factory.
	 * @param javaClass the java class for which this xsd type is to be treated as
	 ...
	 * @param namespace the namespace for the type (used because the grammar loading
	...
	public static XSDDatatype getFromCls(Class<?> javaClass) {
		return clsToXsd.get(javaClass);
	}
	...
	/**
	 * If this datatype is used as the cannonical representation for a particular
	 * java datatype then return that java type, otherwise returns null.
	 */
	@Override
	...
	/**
	 * Returns the Xerces datatype representation for this type, this is an
	 * XSSimpleType, in fact an XSSimpleTypeDecl.
	 */
	@Override
	...
	// It calls into Xerces internal XM parsing, which is problematic if switching
	// to the
...
//    }
	 ...
	 * implementation and are not convered by the explicit convertValidatedData
	 ...
	 * This takes into account typing information as well as lexical form - for
	 * example an xsd:string is never considered valid as an xsd:integer (even if it
	 * is lexically legal like "1").
	 */
	@Override
	 ...
	 * space. If this test passes then if the typed value has a legal lexical form
	 * for this type then it is a legal instance.
	 */
	...
	/**
	 * Return the most specific type below xsd:anySimpleType that this type is
	 * derived from.
	 */
	...
	/**
	 * Helper function to return the substring of a validated number string omitting
	 * any leading + sign.
	 */
...
//        tm.registerDatatype(XSDNMTOKENS);
	 ...
	 * <p>
	 * Datatype template that adapts any response back from Xerces type parsing to
	 * an appropriate java representation. This is primarily used in creating user
