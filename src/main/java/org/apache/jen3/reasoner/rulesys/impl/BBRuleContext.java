...
public class BBRuleContext implements RuleContext {
    ...
    /**
     * @see org.apache.jen3.reasoner.rulesys.RuleContext#contains(org.apache.jen3.graph.Node, org.apache.jen3.graph.Node, org.apache.jen3.graph.Node)
     */
    @Override
    ...
    /**
     * @see org.apache.jen3.reasoner.rulesys.RuleContext#contains(org.apache.jen3.graph.Triple)
     */
    @Override
    ...
    /**
     * @see org.apache.jen3.reasoner.rulesys.RuleContext#find(org.apache.jen3.graph.Node, org.apache.jen3.graph.Node, org.apache.jen3.graph.Node)
     */
    @Override
...
//        return searchpath.find(new TriplePattern(s, p, o));
    ...
    /**
     * @see org.apache.jen3.reasoner.rulesys.RuleContext#getEnv()
     */
    @Override
    ...
    /**
     * @see org.apache.jen3.reasoner.rulesys.RuleContext#getGraph()
     */
    @Override
    ...
    /**
     * @see org.apache.jen3.reasoner.rulesys.RuleContext#getRule()
     */
    @Override
    public Rule getRule() {
        return rule;
    ...
    /**
     * @see org.apache.jen3.reasoner.rulesys.RuleContext#setRule(org.apache.jen3.reasoner.rulesys.Rule)
     */
    @Override
