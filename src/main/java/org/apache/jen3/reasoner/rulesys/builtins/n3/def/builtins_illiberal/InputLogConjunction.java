...
public class InputLogConjunction extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputLogConjunction(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(null, new OneOfIC(new FormulaIC(), new VariableIC())), new VariableIC()), new OneOfIC(new FormulaIC(), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, new FormulaIC()), new OneOfIC(new FormulaIC(), new VariableIC()), null));
