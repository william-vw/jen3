...
public class InputListUnique extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputListUnique(BuiltinDefinition builtin) {
        super(builtin, null);
        ...
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, new ConcreteIC()), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
