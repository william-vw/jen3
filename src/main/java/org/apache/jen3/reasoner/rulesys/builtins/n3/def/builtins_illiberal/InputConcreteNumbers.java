...
public class InputConcreteNumbers extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputConcreteNumbers(BuiltinDefinition builtin) {
        super(builtin, "http://www.w3.org/2000/10/swap/builtin#concreteNumbers");
        ...
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new NumberableIC(), new NumberableIC(), null));
