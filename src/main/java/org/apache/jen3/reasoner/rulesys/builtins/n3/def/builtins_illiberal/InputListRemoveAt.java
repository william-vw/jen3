...
public class InputListRemoveAt extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputListRemoveAt(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(null, null, new OneOfIC(new ListIC(null, null), new VariableIC()), new OneOfIC(new IntableIC(), new VariableIC())), new VariableIC()), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, null, new ListIC(null, null), new IntableIC()), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
