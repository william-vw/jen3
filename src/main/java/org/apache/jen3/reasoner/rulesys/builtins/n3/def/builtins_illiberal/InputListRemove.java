...
public class InputListRemove extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputListRemove(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(null, null, new OneOfIC(new ListIC(null, null), new VariableIC()), new AnyIC()), new VariableIC()), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, null, new ListIC(null, null), new ConcreteIC()), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
