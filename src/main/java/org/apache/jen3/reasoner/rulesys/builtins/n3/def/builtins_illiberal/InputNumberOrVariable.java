...
public class InputNumberOrVariable extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputNumberOrVariable(BuiltinDefinition builtin) {
        super(builtin, "http://www.w3.org/2000/10/swap/builtin#numberOrVariable");
        ...
        addClause(DOMAIN, new OneOfStatementIC(this, new SubjectObjectStatementIC(this, new NumberableIC(), new OneOfIC(new NumberableIC(), new VariableIC()), null), new SubjectObjectStatementIC(this, new OneOfIC(new NumberableIC(), new VariableIC()), new NumberableIC(), null)));
