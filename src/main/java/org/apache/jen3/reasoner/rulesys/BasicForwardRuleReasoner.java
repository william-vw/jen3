...
/**
 * * Reasoner implementation which augments or transforms an RDF graph according
 * to a set of rules. This trivial version does not support separate schema
...
public class BasicForwardRuleReasoner implements Reasoner {
	 ...
	 * These capabilities may be static or may depend on configuration information
	 * supplied at construction time. May be null if there are no useful
	 ...
	 * 
	 * @param configSpec a Model into which the configuration information should be
	 *                   placed
	 * @param base       the Resource to which the configuration parameters should
	 *                   be added.
	 */
	@Override
	...
	/**
	 * Determine whether the given property is recognized and treated specially by
	 * this reasoner. This is a convenience packaging of a special case of
	 * getCapabilities.
	 * 
	 * @param property the property which we want to ask the reasoner about, given
	 *                 as a Node since this is part of the SPI rather than API
	...
	public Reasoner bindSchema(Graph tbox) throws ReasonerException {
		InfGraph graph = new BasicForwardRuleInfGraph(this, rules, null, tbox, tbox.getConfig());
	...
	public Reasoner bindSchema(Model tbox) throws ReasonerException {
		InfGraph graph = new BasicForwardRuleInfGraph(this, rules, null, tbox.getGraph(), tbox.getGraph().getConfig());
		return new BasicForwardRuleReasoner(rules, graph, factory);
	}

	@Override
	public InfGraph bind(Graph data) throws ReasonerException {
		BasicForwardRuleInfGraph graph = new BasicForwardRuleInfGraph(this, rules, schemaGraph, data.getConfig());
	...
	/**
	 * Switch on/off derivation logging. If set to true then the InfGraph created
	 * from the bind operation will start life with recording of derivations
	 * switched on. This is currently only of relevance to rule-based reasoners.
	 * <p>
	 * Default - false.
	 */
	@Override
	 ...
	 * out to the Logger at "INFO" level.
	 */
	 ...
	 * <ul>
	 * <li>BasicForwardedRuleReasoner.PROPderivationLogging - set to true to enable
	 * recording all rule derivations</li>
	 * <li>BasicForwardedRuleReasoner.PROPtraceOn - set to true to enable verbose
	 * trace information to be sent to the logger INFO channel</li>
	 * </ul>
	 * 
	...
	public void setParameter(Property parameter, Object value) {
		if (parameter.equals(ReasonerVocabulary.PROPderivationLogging)) {
			...
			throw new IllegalParameterException(
					"Don't recognize configuration parameter " + parameter + " for rule-based reasoner");
		}
	}

	/**
	 * Return the Jena Graph Capabilities that the inference graphs generated by
	 * this reasoner are expected to conform to.
	 */
	@Override
