...
public class InputListAppend extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputListAppend(BuiltinDefinition builtin) {
        super(builtin, null);
        ...
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, new ListIC(null, null)), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
