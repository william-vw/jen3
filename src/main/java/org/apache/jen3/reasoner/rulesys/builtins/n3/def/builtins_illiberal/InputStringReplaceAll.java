...
public class InputStringReplaceAll extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputStringReplaceAll(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(null, null, new OneOfIC(new StringableIC(), new VariableIC()), new OneOfIC(new ListIC(null, new OneOfIC(new RegexIC(), new VariableIC())), new VariableIC()), new OneOfIC(new ListIC(null, new OneOfIC(new StringableIC(), new VariableIC())), new VariableIC())), new VariableIC()), new OneOfIC(new StringableIC(), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, null, new StringableIC(), new ListIC(null, new RegexIC()), new ListIC(null, new StringableIC())), new OneOfIC(new StringableIC(), new VariableIC()), null));
