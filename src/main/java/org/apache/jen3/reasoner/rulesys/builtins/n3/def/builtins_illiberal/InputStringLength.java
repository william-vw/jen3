...
public class InputStringLength extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputStringLength(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new StringableIC(), new VariableIC()), new OneOfIC(new IntableIC(), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new StringableIC(), new OneOfIC(new IntableIC(), new VariableIC()), null));
