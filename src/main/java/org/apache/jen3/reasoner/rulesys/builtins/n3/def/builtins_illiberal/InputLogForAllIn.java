...
public class InputLogForAllIn extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputLogForAllIn(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(new Cardinality(EXACT, 2), new OneOfIC(new FormulaIC(), new VariableIC())), new VariableIC()), new OneOfIC(new BaseIriIC(), new FormulaIC(), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(new Cardinality(EXACT, 2), new FormulaIC()), new OneOfIC(new BaseIriIC(), new FormulaIC(), new VariableIC()), null));
