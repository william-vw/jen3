 ...
 * to a set of rules. The rules are processed using a tabled LP backchaining
 * interpreter which is implemented by the relevant InfGraph class.
 */
public class LPBackwardRuleReasoner implements Reasoner {
	...
	public InfGraph bind(Graph data) throws ReasonerException {
		LPBackwardRuleInfGraph graph = new LPBackwardRuleInfGraph(this, ruleStore, data, schemaGraph, data.getConfig());
	 ...
	 * reasoner there are no configuration parameters and this method is simply here
	 * to meet the interfaces specification
	 * 
	...
	/**
	 * Return the Jena Graph Capabilties that the inference graphs generated by this
	 * reasoner are expected to conform to.
	 */
	@Override
