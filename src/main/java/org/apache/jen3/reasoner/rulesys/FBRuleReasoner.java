...
//    boolean traceOn = true;
    ...
    */
    ...
    public void addDescription(Model configSpec, Resource base) {
        if (configuration != null) {
            ...
            while (i.hasNext()) {
                Statement st = i.nextStatement();
                configSpec.add(base, st.getPredicateProperty(), st.getObject());
            }
        }
    }
    ...
    public InfGraph bind( Graph data ) throws ReasonerException {
        ...
        FBRuleInfGraph graph = new FBRuleInfGraph( this, rules, schemaArg, schemaArg.getConfig() );
    ...
    */
    ...
    protected synchronized InfGraph getPreload() {
        if (cachePreload && preload == null) {
            preload = (new FBRuleInfGraph(this, rules, null, null));
            preload.prepare();
        }
        return preload;
    }
    ...
    */
    protected boolean doSetRDFNodeParameter( Resource parameter, RDFObject value )
        {
        return
