...
public class InputLogBound extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputLogBound(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new AnyIC(), new OneOfIC(new DatatypeIC(TypeMapper.getInstance().getSafeTypeByName("http://www.w3.org/2001/XMLSchema#boolean"), true), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new AnyIC(), new OneOfIC(new DatatypeIC(TypeMapper.getInstance().getSafeTypeByName("http://www.w3.org/2001/XMLSchema#boolean"), true), new VariableIC()), null));
