...
public class InputGraphLength extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputGraphLength(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new FormulaIC(), new VariableIC()), new OneOfIC(new NumberableIC(), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new FormulaIC(), new OneOfIC(new NumberableIC(), new VariableIC()), null));
