...
public class InputIriAndStringOrVariable extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputIriAndStringOrVariable(BuiltinDefinition builtin) {
        super(builtin, "http://www.w3.org/2000/10/swap/builtin#iriAndStringOrVariable");
