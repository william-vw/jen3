...
import org.apache.jen3.reasoner.rulesys.impl.RDFSCMPPreprocessHook;
...
public class RDFSRuleReasoner extends GenericRuleReasoner {
    ...
    public RDFSRuleReasoner(ReasonerFactory factory, Resource configuration) {
        ...
        if (configuration != null) {
            ...
            while (i.hasNext()) {
                ...
                doSetParameter(st.getPredicateProperty(), st.getObject().toString());
            }
        }
    }
    ...
    public Reasoner bindSchema(Graph tbox) throws ReasonerException {
        ...
        FBRuleInfGraph graph = new FBRuleInfGraph(this, rules, getPreload(), tbox, tbox.getConfig());
