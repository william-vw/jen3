...
public class InputStringScrapeAll extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputStringScrapeAll(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(null, null, new OneOfIC(new StringableIC(), new VariableIC()), new OneOfIC(new RegexIC(), new VariableIC())), new VariableIC()), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, null, new StringableIC(), new RegexIC()), new OneOfIC(new ListIC(null, null), new VariableIC()), null));
