...
public class RETERuleInfGraph extends BasicForwardRuleInfGraph {
     ...
     */
    public RETERuleInfGraph(Reasoner reasoner, List<Rule> rules, Graph schema, GraphConfig config) {
      ...
      */
     public RETERuleInfGraph(Reasoner reasoner, List<Rule> rules, Graph schema, Graph data, GraphConfig config) {
