...
public class InputLogLanglit extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputLogLanglit(BuiltinDefinition builtin) {
        super(builtin, null);
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(null, null, new OneOfIC(new StringableIC(), new VariableIC()), new OneOfIC(new StringableIC(), new VariableIC())), new VariableIC()), new OneOfIC(new LiteralIC(), new VariableIC()), null));
        addClause(DOMAIN, new OneOfStatementIC(this, new SubjectObjectStatementIC(this, new ListIC(null, null, new StringableIC(), new StringableIC()), new OneOfIC(new LiteralIC(), new VariableIC()), null), new SubjectObjectStatementIC(this, new ListIC(null, null, new VariableIC(), new VariableIC()), new LiteralIC(), null), new SubjectObjectStatementIC(this, new VariableIC(), new LiteralIC(), null)));
