...
public class InputNumberIntListAndNumberOrVariable extends InputConstraintsDefinition {

    private static final long serialVersionUID = 1;

    public InputNumberIntListAndNumberOrVariable(BuiltinDefinition builtin) {
        super(builtin, "http://www.w3.org/2000/10/swap/builtin#numberIntListAndNumberOrVariable");
        addClause(ACCEPT, new SubjectObjectStatementIC(this, new OneOfIC(new ListIC(null, null, new OneOfIC(new NumberableIC(), new VariableIC()), new OneOfIC(new IntableIC(), new VariableIC())), new VariableIC()), new OneOfIC(new NumberableIC(), new VariableIC()), null));
        addClause(DOMAIN, new SubjectObjectStatementIC(this, new ListIC(null, null, new NumberableIC(), new IntableIC()), new OneOfIC(new NumberableIC(), new VariableIC()), null));
