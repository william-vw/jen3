...
package org.apache.jen3.shared.impl;
...
public class PrefixMappingImpl implements PrefixMapping
	...
	public PrefixMapping setBase(String uri) 
    	...
    	checkUnlocked();
    	checkProper(uri);
    	if (uri == null) throw new NullPointerException( "null URIs are prohibited as arguments to setBase" );
		this.baseURI = uri;
		return this;
    	}
    ...
    public static boolean isNiceURI( String uri )
        ...
        return TermUtil.notNameChar( last ); 
        }
    ...
    */
    ...
    <p>
        ...
        have to (reverse-)lookup the namespace in the prefix table.
     	...
     	@see org.apache.jen3.shared.PrefixMapping#qnameFor(java.lang.String)
    */
    @Override
