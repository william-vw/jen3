...
import org.apache.jen3.vocabulary.DC_11;
import org.apache.jen3.vocabulary.OWL;
import org.apache.jen3.vocabulary.RDF;
import org.apache.jen3.vocabulary.RDFS;
import org.apache.jen3.vocabulary.RSS;
import org.apache.jen3.vocabulary.VCARD;
...
public interface PrefixMapping
    {
	/**
	 * Specify the base URI. This is different from the empty prefix string in N3.
	 * 
	 * @param uri
	 * @return
	 */
	PrefixMapping setBase(String uri);
	
	/**
	 * Get the base URI. This is different from the empty prefix string in N3.
	 * 
	 * @param uri
	 * @return
	 */
