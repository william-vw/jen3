...
import org.apache.jen3.graph.impl.TripleStore;
...
public class GraphMem extends GraphMemBase {
	...
	/**
	 * The GraphMemStatisticsHandler exploits the existing TripleStoreMem indexes to
	 * deliver statistics information for single-concrete-node queries and for
	...
	protected static class GraphMemStatisticsHandler implements GraphStatisticsHandler {
		...
		/**
		 * Answer a good estimate of the number of triples matching (S, P, O) if cheaply
		 * possible.
		 * 
		 * <p>
		 * If there are any reifier triples, return -1. (We may be able to improve this
		 * later.)
		 * 
		 * <p>
		 * If only one of S, P, O is concrete, answers the number of triples with that
		 * value in that field.
		 * 
		 * <p>
		 * If two of S, P, P are concrete and at least one of them has no corresponding
		 * triples, answers 0.
		 * 
		 * <p>
		 * Otherwise answers -1, ie, no information available. (May change; the two
		 * degenerate cases might deserve an answer.)
		 * 
		 * @see org.apache.jen3.graph.GraphStatisticsHandler#getStatistic(org.apache.jen3.graph.Node,
		 *      org.apache.jen3.graph.Node, org.apache.jen3.graph.Node)
		 */
		@Override
