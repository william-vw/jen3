...
import static org.apache.jen3.util.iterator.WrappedIterator.create;
...
public class NodeToTriplesMap extends NodeToTriplesMapBase 
    ...
    @Override public ExtendedIterator<Triple> iterator( Node index, Node n2, Node n3, boolean matchAbsolute)
        {
    ...
    */
    ...
    /** 
        @see org.apache.jena.mem.Temp#getClause(java.lang.Object)
    */
