...
public abstract class NodeToTriplesMapBase {
	...
	/**
	 * The number of triples held in this NTM, maintained incrementally (because
	...
	/**
	 * Whether a variable was indexed on indexField.
	 */
	protected boolean indexedVars = false;
	...
	public void removedOneViaIterator() {
		size -= 1;
		/* System.err.println( ">> rOVI: size := " + size ); */ }

	public boolean isEmpty() {
		return size == 0;
	}

	public abstract ExtendedIterator<Triple> iterator(Node index, Node n2, Node n3, boolean matchAbsolute);
